...
$result = mysqli_query($connect,"select * from workout where id='$id'");
            ...
            <div class="card">
              <div class="card-body text-center">
                ...
                <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                  <div class="row mb-3">
                    <input type="text" name="icon" value="<?php echo $icon;  ?>" required class="form-control" placeholder="Image">
                  </div>
                  ...
                  <div class="row align-self-center text-center m-t-5">
                    ...
                    if (isset($_POST['submit'])) {
                      ...
                      mysqli_query($connect,"update workout set icon='$icon',title='$title',description='$description' where id='$id'");
