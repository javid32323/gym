...
$result = mysqli_query($connect,"select * from team_form where id='$id'");
                  ...
                  <div class="row align-self-center text-center m-t-5">
                    ...
                    if (isset($_POST['submit'])) {
                      ...
                      $path = $folder.basename($imagename);
                             ...
                             mysqli_query($connect,"update team_form set image='$imagename',profession='$profession',name='$name' where id='$id'");
                      echo "Record added successfully";
                      echo "<script>window.location.href = 'team-list.php'</script>";
                              }
