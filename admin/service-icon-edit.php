          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body text-center">
                <h3 class="mb-5 mt-4">Service Update Form</h3>
                <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                  
                  <div class="row mb-3">
                    <input type="text" name="icon" value="<?php echo $icon;  ?>"  class="form-control" placeholder="icon">
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="row align-self-center text-center m-t-5">
                    ...
                    if (isset($_POST['submit'])) {
                      ...
                      mysqli_query($connect, "update  service set icon='$icon',description='$description' where id='$id'");
                      echo "Record Updated successfully";
                      echo "<script>window.location.href = 'service-icon-list.php'</script>";
