...
$result = mysqli_query($connect,"select * from counter where id='$id'");
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body text-center">
                <h3 class="mb-5 mt-4">Counter Update Form</h3>
                <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row mb-3">
                    <input type="text" name="count" value="<?php echo $count;  ?>"  class="form-control" placeholder="count">
                  </div>
                  ...
                  <div class="row align-self-center text-center m-t-5">
                    ...
                    if (isset($_POST['submit'])) {
                      ...
                      mysqli_query($connect, "update  counter set image='$imagename',title='$title',count='$count' where id='$id'");
                      echo "Record Update successfully";
                      echo "<script>window.location.href = 'counter-list.php'</script>";
                              }
