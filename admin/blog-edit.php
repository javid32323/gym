...
$result = mysqli_query($connect,"select * from blog_image where id='$id'");
            ...
            <div class="card">
              <div class="card-body text-center">
                ...
                <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row mb-3">
                    <input type="date" name="date" value="<?php echo $date;  ?>" placeholder="date"  class="form-control" >
                  </div>
                  ...
                  <div class="row align-self-center text-center m-t-5">
                    ...
                    if (isset($_POST['submit'])) {
                      ...
                      $path = $folder.basename($imagename);
                             ...
                             mysqli_query($connect,"update blog_image set image='$imagename',date='$date',title='$title',text='$text' where id='$id'");
