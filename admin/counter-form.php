          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body text-center">
                <h3 class="mb-5 mt-4">Counter Form</h3>
                <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row mb-3">
                    <input type="number" name="count" required class="form-control" placeholder="count">
                  </div>
                  ...
                  <div class="row align-self-center text-center m-t-5">
                    ...
                    if (isset($_POST['submit'])) {
                      ...
                      mysqli_query($connect, "insert into counter values('','$imagename','$title','$count')");
