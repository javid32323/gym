...
$result = mysqli_query($connect,"select * from video_intro where id='$id'");
                ...
                <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row align-self-center text-center m-t-5">
                    ...
                    if (isset($_POST['submit'])) {
                      ...
                      mysqli_query($connect,"update  video_intro set image='$imagename',icon='$icon',title='$title',description='$description' where id='$id'");
